...
3. [Governance Manual](./docs/governance/epithema_governance_manual.md)
...
- Do not modify the sister repository `../epithemaR` unless a prompt explicitly
