...
use epithema_core::{Interval, SequenceIdentifier, SequenceRecord};
...
fn build_fragment(
    base: &str,
    suffix: &str,
    molecule: epithema_core::MoleculeKind,
    residues: &str,
    metadata: epithema_core::SequenceMetadata,
...
mod tests {
    ...
    fn record(id: &str, residues: &str) -> epithema_core::SequenceRecord {
