//! Governed Epithema tool descriptors and shared tool-family implementations.

use epithema_core::{PLATFORM_IDENTITY, PlatformIdentity};
...
pub mod primer_tools;
pub mod protein_coordinates;
...
pub struct ToolDescriptor {
    /// Stable tool name as exposed through `epithema <tool>`.
    pub name: &'static str,
...
pub const fn governed_tool_descriptors() -> &'static [ToolDescriptor] {
    &[
        ...
        archive_tools::ASSEMBLYGET_DESCRIPTOR,
        archive_tools::INFOASSEMBLY_DESCRIPTOR,
        archive_tools::RUNINFO_DESCRIPTOR,
        archive_tools::RUNGET_DESCRIPTOR,
        archive_tools::NGSLIST_DESCRIPTOR,
        archive_tools::NGSGET_DESCRIPTOR,
        ...
        retrieval_tools::SEQRETSETALL_DESCRIPTOR,
        retrieval_tools::SEQRETSPLIT_DESCRIPTOR,
        retrieval_tools::REFSEQGET_DESCRIPTOR,
        retrieval_tools::WHICHDB_DESCRIPTOR,
        ...
        protein_plots::PEPINFO_DESCRIPTOR,
        protein_plots::PEPWINDOW_DESCRIPTOR,
        primer_tools::EPRIMER3_DESCRIPTOR,
        primer_tools::PRIMERSEARCH_DESCRIPTOR,
        primer_tools::SIRNA_DESCRIPTOR,
        protein_coordinates::PSIPHI_DESCRIPTOR,
...
mod tests {
    ...
    fn binds_to_platform_identity() {
        assert_eq!(ToolRegistry::new().platform().binary_name, "epithema");
    }
