...
pub fn maskambignuc_help() -> &'static str {
    "Usage: epithema maskambignuc <input>\n\nMask conservative nucleotide ambiguity residues with N in each input record. The Epithema v1 implementation supports DNA and RNA inputs, preserves record order and annotations, and leaves canonical A/C/G/T/U residues unchanged."
}
