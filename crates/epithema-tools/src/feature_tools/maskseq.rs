...
use epithema_core::{Interval, SequenceRecord, mask_intervals};
...
#[cfg(test)]
mod tests {
    use epithema_core::{Interval, MoleculeKind, SequenceIdentifier, mask_intervals};
