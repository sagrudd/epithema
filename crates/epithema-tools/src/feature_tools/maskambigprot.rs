...
use epithema_core::{SequenceRecord, mask_intervals};
...
pub fn maskambigprot_help() -> &'static str {
    "Usage: epithema maskambigprot <input>\n\nMask conservative protein ambiguity residues with X in each input record. The Epithema v1 implementation treats B, J, X, and Z as ambiguity symbols, preserves record order and annotations, and leaves canonical amino-acid symbols unchanged."
}
