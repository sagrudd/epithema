...
use epithema_core::{SequenceMetadata, SequenceRecord, SequenceTopology};
...
mod tests {
    ...
    use epithema_core::{Alphabet, MoleculeKind, SequenceIdentifier, SequenceRecord};
