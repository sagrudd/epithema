...
use epithema_core::{NucleotideDensityError, NucleotideDensityProfile, nucleotide_density_profile};
...
mod tests {
    ...
    use epithema_core::{DensityWindow, NucleotideDensityError, NucleotideDensityProfile};
