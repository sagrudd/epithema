...
use epithema_core::{NucleotideBananaError, NucleotideBananaProfile, nucleotide_banana_profile};
...
mod tests {
    ...
    use epithema_core::{BananaPoint, NucleotideBananaError, NucleotideBananaProfile};
