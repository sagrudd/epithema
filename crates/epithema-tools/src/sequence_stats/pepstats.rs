...
use epithema_core::{Alphabet, MoleculeKind, ResidueComposition, protein_molecular_weight};
...
fn looks_like_protein_record(record: &epithema_core::SequenceRecord) -> bool {
    Alphabet::Protein
        .validate(MoleculeKind::Protein, record.residues())
        .is_ok()
}

fn looks_like_nucleotide_record(record: &epithema_core::SequenceRecord) -> bool {
    Alphabet::Dna
