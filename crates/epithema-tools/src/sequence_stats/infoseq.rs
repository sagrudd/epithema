...
use epithema_core::{Alphabet, GcSummary, MoleculeKind, SequenceRecord};
...
mod tests {
    ...
    use epithema_core::{MoleculeKind, SequenceIdentifier, SequenceMetadata, SequenceTopology};
    ...
    fn omits_gc_for_protein_records() {
        let record = epithema_core::SequenceRecord::new(
