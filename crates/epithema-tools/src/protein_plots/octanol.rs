...
use epithema_core::{ProteinOctanolError, ProteinOctanolProfile, protein_octanol_profile};
...
mod tests {
    ...
    use epithema_core::{OctanolWindow, ProteinOctanolError, ProteinOctanolProfile};
