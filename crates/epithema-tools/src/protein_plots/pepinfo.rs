...
use epithema_core::{ProteinPepinfoError, ProteinPepinfoProfile, protein_pepinfo_profile};
...
mod tests {
    ...
    use epithema_core::{PepinfoWindow, ProteinPepinfoError, ProteinPepinfoProfile};
