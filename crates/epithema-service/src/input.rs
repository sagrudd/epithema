...
use epithema_diagnostics::{ArtifactProvenance, Diagnostic, Severity};
use epithema_providers::{AcquisitionRequest, InputReference, ProviderId, ResolutionIntent};
    ...
    fn resolve_inline(&self, reference: ToolInputReference) -> ToolInputResolution {
        ...
        ToolInputResolution::InlineSequence {
            ...
            provenance: ArtifactProvenance::new(
                epithema_diagnostics::ArtifactOriginKind::Unknown,
...
mod tests {
    ...
    use epithema_core::MoleculeKind;
    use epithema_diagnostics::ArtifactOriginKind;
    use epithema_providers::ResolutionIntent;

    use super::{ToolInputKind, ToolInputResolution, ToolInputResolver};

    #[test]
    fn resolves_existing_local_file() {
        let temp_dir = std::env::temp_dir().join(unique_name("epithema-service-input"));
