...
- Service coverage: `copies_verified_existing_download_candidate_before_network_download`
- Service coverage: `fails_when_existing_download_candidate_has_unexpected_checksum`
