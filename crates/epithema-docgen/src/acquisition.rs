...
use epithema_config::AutodocPolicy;
use epithema_diagnostics::{ArtifactProvenance, Diagnostic, ErrorCategory, PlatformError};
        ...
        (
            ...
            let gateway = gateway.ok_or_else(|| {
                PlatformError::new(
                    ...
                    "provider-backed documentation artefact requires a formal Epithema acquisition gateway",
                )
...
mod tests {
    ...
    impl DocumentationAcquisitionGateway for FakeGateway {
        ...
        ) -> Result<DocumentationAcquisitionRecord, epithema_diagnostics::PlatformError> {
            Ok(DocumentationAcquisitionRecord::new(
    ...
    fn rejects_direct_download_like_reference() {
        let json = r#"
        {
          "schema_version": "epithema.autodoc/v1",
