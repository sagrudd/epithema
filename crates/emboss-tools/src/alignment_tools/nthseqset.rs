...
pub fn nthseqset_help() -> &'static str {
    "Usage: emboss-rs nthseqset <input> <number>\n\nSelect one 1-based alignment set from an input file containing one or more alignments. EMBOSS-RS v1 accepts Stockholm multi-alignment inputs plus single aligned FASTA or Stockholm files, and emits the selected alignment as Stockholm."
}
