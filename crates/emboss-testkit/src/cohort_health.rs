...
mod tests {
    ...
    fn derives_report_for_current_repository_state() {
        ...
        assert_eq!(report.summary.weakest_evidence_family, None);
    ...
    fn renders_stable_markdown() {
        ...
        assert!(markdown.contains("Weakest evidence family: `none`"));
        assert!(markdown.contains("No reprioritization signals were generated."));
        assert!(markdown.contains("No recommendation changes are required."));
