...
mod tests {
    ...
    fn derives_report_for_current_repository_state() {
        ...
        assert_eq!(report.summary.total_method_count, 102);
        assert_eq!(report.summary.compared_evidence_count, 101);
        ...
        assert_eq!(report.below_compared_methods[0].tool_name, "isochore");
    }
    ...
    fn renders_stable_markdown() {
        ...
        assert!(markdown.contains("## Below-Compared Exceptions"));
        assert!(markdown.contains("`isochore`"));
    }
}
