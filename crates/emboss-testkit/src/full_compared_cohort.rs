...
mod tests {
    ...
    fn derives_report_for_current_repository_state() {
        ...
        assert_eq!(report.summary.total_method_count, 99);
        assert_eq!(report.summary.compared_evidence_count, 98);
        ...
        assert_eq!(report.below_compared_methods[0].tool_name, "pepinfo");
    }
    ...
    fn renders_stable_markdown() {
        ...
        assert!(markdown.contains("Methods below compared evidence: `1`"));
        assert!(markdown.contains("| `pepinfo` |"));
    }
}
