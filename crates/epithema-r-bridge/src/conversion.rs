...
use epithema_core::{Alignment, Feature, PLATFORM_IDENTITY, SequenceRecord};
use epithema_diagnostics::{Diagnostic, PlatformError};
use epithema_plot_contract::PlotSpec;
use epithema_service::{
    ArtifactReference, EpithemaService, MethodResult, ResultPayload, TableReport,
};
...
impl From<&epithema_diagnostics::ArtifactProvenance> for BridgeProvenanceSummary {
    fn from(value: &epithema_diagnostics::ArtifactProvenance) -> Self {
        Self {
...
#[must_use]
pub fn project_health(service: &EpithemaService) -> BridgeHealth {
    BridgeHealth {
        sister_package: PLATFORM_IDENTITY.sister_project.to_owned(),
        plot_backend: PLATFORM_IDENTITY.plot_backend.to_owned(),
        ...
        operation_status: BridgeOperationStatus {
            ok: true,
            message: "Rust bridge scaffold is ready for future epithemaR bindings".to_owned(),
        },
    }
}
...
mod tests {
    ...
    use epithema_service::{
        ArtifactKind, ArtifactReference, EpithemaService, MethodResult, ResultPayload,
        ResultSummary, TableReport, ToolName,
    };
    use epithema_tools::ToolDescriptor;
    ...
    fn projects_version_metadata() {
        ...
        assert_eq!(version.binary_name, "epithema");
    ...
    fn projects_health_from_service() {
        ...
        assert_eq!(health.sister_package, "epithemaR");
