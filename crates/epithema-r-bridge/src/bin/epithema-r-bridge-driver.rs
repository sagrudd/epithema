//! Developer-facing JSON bridge driver for the first `epithemaR` method surface.

use std::io::{self, Read};

use epithema_r_bridge::list_tools;
use epithema_r_bridge::protocol::{BridgeRequest, BridgeResponse};
