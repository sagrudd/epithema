...
use epithema_core::{MoleculeKind, SequenceIdentifier, SequenceMetadata, SequenceRecord};
    ...
    for record in records {
        ...
        let topology = record
            ...
            .map(|value| match value {
                epithema_core::SequenceTopology::Linear => "linear",
                epithema_core::SequenceTopology::Circular => "circular",
            })
            .unwrap_or("linear");
...
#[cfg(test)]
mod tests {
    use epithema_core::{FeatureKind, MoleculeKind, Strand};
