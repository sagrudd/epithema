...
This section contains Markdown pages generated from validated `epithema autodoc` inputs. These files are deterministic documentation source artefacts intended for Sphinx ingestion.
