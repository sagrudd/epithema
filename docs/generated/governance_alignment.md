...
- Shipped tools with compared evidence: `111`
...
| Modernize — Rework — Command discovery and help-navigation | 0 | 0 | 0 | 1 | 1 | 0 | family is aligned at the current governance and evidence threshold |
...
| `wossname` | `command_tools` | Modernize — Rework — Command discovery and help-navigation | rework | yes | `executable_evidence` |
...
| `sirna` | `primer_tools` | Modernize — Rework — Primer and assay-oriented search | rework | yes | `compared_evidence` |
