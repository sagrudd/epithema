...
- Shipped tools: `105`
- Shipped tools with governance mapping: `105`
- Retained backlog still unshipped: `0`
- Shipped tools with curated autodoc: `105`
- Shipped tools with executable or compared evidence: `105`
- Shipped tools with harvested legacy provenance: `105`
- Shipped tools with compared evidence: `104`
- Shipped tools still documented-only: `0`

## Shipped Decision Split

- Shipped retain methods: `90`
- Shipped rework methods: `15`
...
| Modernize — Rework — Remote retrieval and archive acquisition | 0 | 0 | 0 | 5 | 5 | 4 | family is aligned at the current governance and evidence threshold |
...
| `seqretsetall` | `retrieval_tools` | Modernize — Rework — Remote retrieval and archive acquisition | rework | yes | `executable_evidence` |
