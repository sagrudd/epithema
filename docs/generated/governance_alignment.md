...
- Shipped tools: `97`
- Shipped tools with governance mapping: `97`
- Retained backlog still unshipped: `0`
- Shipped tools with curated autodoc: `97`
- Shipped tools with executable or compared evidence: `97`
- Shipped tools with harvested legacy provenance: `97`
...
| Modernize — Rework — Plotting and visualization tools | 0 | 0 | 0 | 3 | 3 | 2 | family is aligned at the current governance and evidence threshold |
...
| `hmoment` | `protein_plots` | Modernize — Rework — Plotting and visualization tools | rework | yes | `executable_evidence` |
