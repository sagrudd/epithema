...
- Shipped tools: `100`
- Shipped tools with governance mapping: `100`
- Retained backlog still unshipped: `0`
- Shipped tools with curated autodoc: `100`
- Shipped tools with executable or compared evidence: `100`
- Shipped tools with harvested legacy provenance: `100`
- Shipped tools with compared evidence: `99`
- Shipped tools still documented-only: `0`

## Shipped Decision Split

- Shipped retain methods: `90`
- Shipped rework methods: `10`
...
| Modernize — Rework — Plotting and visualization tools | 0 | 0 | 0 | 6 | 6 | 5 | family is aligned at the current governance and evidence threshold |
...
| `density` | `nucleotide_plots` | Modernize — Rework — Plotting and visualization tools | rework | yes | `executable_evidence` |
