...
- Shipped tools with compared evidence: `108`
...
| Modernize — Rework — Primer and assay-oriented search | 0 | 0 | 0 | 1 | 1 | 0 | family is aligned at the current governance and evidence threshold |
...
| `primersearch` | `primer_tools` | Modernize — Rework — Primer and assay-oriented search | rework | yes | `executable_evidence` |
