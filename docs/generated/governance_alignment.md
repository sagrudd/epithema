...
- Shipped tools: `104`
- Shipped tools with governance mapping: `104`
- Retained backlog still unshipped: `0`
- Shipped tools with curated autodoc: `104`
- Shipped tools with executable or compared evidence: `104`
- Shipped tools with harvested legacy provenance: `104`
- Shipped tools with compared evidence: `103`
- Shipped tools still documented-only: `0`

## Shipped Decision Split

- Shipped retain methods: `90`
- Shipped rework methods: `14`
...
| Modernize — Rework — Plotting and visualization tools | 0 | 0 | 0 | 10 | 10 | 9 | family is aligned at the current governance and evidence threshold |
...
| `syco` | `nucleotide_plots` | Modernize — Rework — Plotting and visualization tools | rework | yes | `executable_evidence` |
