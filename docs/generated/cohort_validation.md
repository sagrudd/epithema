...
- Methods in cohort: `105`
- Documentation-complete methods: `105`
- Methods with validation stubs: `105`
...
| `seqretsetall` | `retrieval_tools` | `executable_evidence` | `yes` | `yes` | `yes` | `yes` | `no` | `1` |
...
- `seqretsetall`: `missing_compared_evidence`
