...
- Methods with compared evidence: `111`
...
| `wossname` | `command_tools` | `executable_evidence` | `yes` | `yes` | `yes` | `yes` | `no` | `1` |
...
| `sirna` | `primer_tools` | `compared_evidence` | `yes` | `yes` | `yes` | `yes` | `yes` | `0` |
...
- `wossname`: `missing_compared_evidence`
