...
- Methods in cohort: `106`
- Documentation-complete methods: `106`
- Methods with validation stubs: `106`
...
- Methods with compared evidence: `105`
...
| `seqretsplit` | `retrieval_tools` | `executable_evidence` | `yes` | `yes` | `yes` | `yes` | `no` | `1` |
...
- `seqretsplit`: `missing_compared_evidence`
