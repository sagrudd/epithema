...
- All `115` shipped methods are documented and present in the generated docs
  index.
- All `115` shipped methods have a checked-in validation stub.
...
- Basis: the full-compared-cohort gate is generated at:
  ...
  and now records `115/115` shipped methods at compared evidence with `0`
...
- Basis: the harvest-coverage exceptions report is generated at:
  ...
  and now records `115/115` shipped methods with harvested legacy
...
- The cohort report now records `115` methods with harvested legacy
  provenance.
- Harvest coverage is complete across the shipped cohort at this checkpoint.

### Comparison-based acceptance is complete

- The cohort report now records `115` methods with compared evidence and `0`
