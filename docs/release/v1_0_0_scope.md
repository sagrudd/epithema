...
- the governed `emboss-rs <tool>` single-binary command surface
...
- the Rust plot-contract layer and the sister `emboss-r` rendering path
...
- CRAN or Bioconductor publication for `emboss-r`
